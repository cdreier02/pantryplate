...
export const SEED_MEALS = [
  ...
  },
  {
    ...
    type: "Breakfast", time: 20, fiber: 8, protein: 9, sat: "very low", cal: 330,
    why: "Steel-cut oats bring beta-glucan, the soluble fiber that helps pull LDL down; apple adds pectin, another soluble fiber.",
    tags: ["high-fiber", "make-ahead", "batch"],
    ingredients: ["½ cup steel-cut oats", "1½ cups water or soy milk", "1 apple, diced", "1 tbsp chopped walnuts", "½ tsp cinnamon", "1 tsp maple syrup (optional)"],
    steps: ["Simmer oats in water or milk 15–18 min, stirring now and then.", "Stir in half the apple and the cinnamon.", "Top with the rest of the apple, the walnuts and a drizzle of maple."],
  },
  {
    id: "vanilla-chia-pudding",
    name: "Vanilla Chia Pudding with Berries",
    type: "Breakfast", time: 5, fiber: 11, protein: 8, sat: "very low", cal: 300,
    why: "Chia seeds are loaded with soluble fiber and ALA omega-3s — a no-cook, heart-smart make-ahead.",
    tags: ["high-fiber", "make-ahead", "no-cook", "omega-3"],
    ingredients: ["3 tbsp chia seeds", "1 cup soy or low-fat milk", "½ tsp vanilla", "1 tsp maple syrup", "½ cup berries", "1 tbsp chopped almonds"],
    steps: ["Whisk chia, milk, vanilla and maple in a jar.", "Refrigerate at least 3 hours or overnight, stirring once early on.", "Top with berries and almonds before eating."],
  },
  {
    id: "pb-green-smoothie",
    name: "Peanut Butter Banana Green Smoothie",
    type: "Breakfast", time: 5, fiber: 7, protein: 14, sat: "very low", cal: 320,
    why: "Soy milk and peanut butter add unsaturated fat and protein; oats and spinach quietly stack soluble fiber.",
    tags: ["quick", "no-cook", "high-protein", "soy-protein"],
    ingredients: ["1 cup soy milk", "1 banana", "1 tbsp natural peanut butter", "2 tbsp rolled oats", "1 large handful spinach", "½ cup ice"],
    steps: ["Add everything to a blender.", "Blend until smooth.", "Add a splash more milk if it's too thick."],
  },
  {
    id: "bircher-muesli",
    name: "Bircher Muesli with Apple & Walnuts",
    type: "Breakfast", time: 5, fiber: 9, protein: 11, sat: "very low", cal: 350,
    why: "Raw oats soaked overnight keep their soluble fiber; apple and walnuts pile on fiber and unsaturated fat.",
    tags: ["high-fiber", "make-ahead", "no-cook"],
    ingredients: ["½ cup rolled oats", "½ cup soy or low-fat milk", "2 tbsp plain low-fat yogurt", "1 apple, grated", "2 tbsp chopped walnuts", "1 tsp honey or maple", "Squeeze of lemon"],
    steps: ["Stir oats, milk and yogurt together.", "Mix in the grated apple, lemon and sweetener.", "Chill overnight; top with walnuts before eating."],
  },
  {
    id: "bean-breakfast-burrito",
    name: "Black Bean Breakfast Burrito",
    type: "Breakfast", time: 15, fiber: 11, protein: 18, sat: "low", cal: 400,
    why: "Black beans and tofu give cholesterol-free protein and fiber; salsa and avocado satisfy without saturated fat.",
    tags: ["high-protein", "high-fiber", "savory"],
    ingredients: ["1 whole wheat tortilla", "½ cup black beans, warmed", "¼ block firm tofu, crumbled", "¼ tsp turmeric", "Pinch cumin", "2 tbsp salsa", "¼ avocado, sliced", "Handful spinach"],
    steps: ["Sauté the crumbled tofu with turmeric and cumin 4 min.", "Warm the beans and wilt the spinach.", "Pile tofu, beans, spinach, salsa and avocado in the tortilla and roll up."],
  },
  {
    id: "lentil-tabbouleh",
    name: "Lentil Tabbouleh",
    type: "Lunch", time: 20, fiber: 12, protein: 14, sat: "very low", cal: 300,
    why: "Lentils swap in for some of the bulgur to add soluble fiber and protein; olive oil and lemon keep it bright.",
    tags: ["high-fiber", "high-protein", "make-ahead", "no-cook"],
    ingredients: ["1 cup cooked green lentils", "½ cup cooked bulgur", "1 cup parsley, chopped", "½ cup mint, chopped", "2 tomatoes, diced", "2 scallions, sliced", "2 tbsp olive oil", "1 lemon, juiced", "Salt & pepper"],
    steps: ["Combine lentils, bulgur, herbs, tomato and scallion.", "Dress with olive oil, lemon, salt and pepper.", "Let sit 10 min so the flavors meld."],
  },
  {
    id: "edamame-soba-salad",
    name: "Edamame & Soba Noodle Salad",
    type: "Lunch", time: 20, fiber: 8, protein: 18, sat: "low", cal: 410,
    why: "Edamame and soba bring soy protein and fiber; a sesame-ginger dressing uses unsaturated fat instead of cream.",
    tags: ["high-protein", "make-ahead", "soy-protein"],
    ingredients: ["3 oz soba noodles", "1 cup shelled edamame", "1 carrot, julienned", "1 cup shredded cabbage", "2 scallions, sliced", "1 tbsp low-sodium soy sauce", "1 tbsp rice vinegar", "1 tsp sesame oil", "1 tsp grated ginger", "1 tsp sesame seeds"],
    steps: ["Cook soba, then rinse cold.", "Whisk soy sauce, vinegar, sesame oil and ginger.", "Toss noodles with edamame, vegetables and dressing; top with sesame seeds."],
  },
  {
    id: "barley-tahini-bowl",
    name: "Barley & Roasted Veg Bowl with Tahini",
    type: "Lunch", time: 35, fiber: 13, protein: 13, sat: "low", cal: 430,
    why: "Barley is exceptionally high in beta-glucan soluble fiber; tahini and chickpeas round it out with unsaturated fat and protein.",
    tags: ["high-fiber", "make-ahead", "one-pot"],
    ingredients: ["¾ cup pearl barley", "1 can chickpeas, drained", "1 zucchini, chopped", "1 red onion, in wedges", "1 tbsp olive oil", "2 tbsp tahini", "1 lemon, juiced", "1 clove garlic, grated", "Handful parsley"],
    steps: ["Simmer barley 25–30 min until tender; drain.", "Roast chickpeas, zucchini and onion with olive oil at 425°F / 220°C for 20 min.", "Whisk tahini, lemon, garlic and a little water; toss everything together with parsley."],
  },
  {
    id: "smashed-chickpea-sandwich",
    name: "Smashed Chickpea Salad Sandwich",
    type: "Lunch", time: 10, fiber: 9, protein: 13, sat: "low", cal: 360,
    why: "Mashed chickpeas stand in for tuna or chicken salad — fiber and plant protein, bound with avocado instead of mayo.",
    tags: ["high-fiber", "quick", "no-cook"],
    ingredients: ["1 can chickpeas, drained", "¼ avocado", "1 tbsp lemon juice", "1 celery stalk, diced", "2 tbsp diced red onion", "1 tsp Dijon mustard", "4 slices whole-grain bread", "Lettuce & tomato"],
    steps: ["Mash chickpeas with avocado, lemon and mustard.", "Stir in the celery and onion; season.", "Pile onto bread with lettuce and tomato."],
  },
  {
    id: "spiced-roasted-chickpeas",
    name: "Spiced Roasted Chickpeas",
    type: "Snack", time: 35, fiber: 8, protein: 9, sat: "very low", cal: 190,
    why: "A crunchy, high-fiber stand-in for chips, with plant protein and barely any fat.",
    tags: ["low-cal", "high-fiber", "snack", "gluten-free"],
    ingredients: ["1 can chickpeas, drained and patted dry", "1 tsp olive oil", "½ tsp smoked paprika", "½ tsp cumin", "¼ tsp garlic powder", "Salt"],
    steps: ["Toss the dry chickpeas with oil and spices.", "Roast at 400°F / 200°C for 25–30 min, shaking halfway.", "Cool 5 min for maximum crunch."],
  },
  {
    id: "walnut-date-bites",
    name: "Walnut & Date Energy Bites",
    type: "Snack", time: 15, fiber: 6, protein: 6, sat: "very low", cal: 170,
    why: "Oats and dates bring soluble fiber while walnuts and peanut butter supply heart-healthy unsaturated fat — no baking.",
    tags: ["no-cook", "make-ahead", "omega-3", "snack"],
    ingredients: ["1 cup rolled oats", "1 cup pitted dates", "¼ cup walnuts", "2 tbsp natural peanut butter", "1 tbsp ground flaxseed", "Pinch salt"],
    steps: ["Blitz dates and walnuts to a paste in a food processor.", "Add oats, peanut butter, flax and salt; pulse to combine.", "Roll into balls and chill 20 min."],
  },
  {
    id: "edamame-sea-salt",
    name: "Sea-Salt Steamed Edamame",
    type: "Snack", time: 10, fiber: 8, protein: 17, sat: "very low", cal: 190,
    why: "Whole soybeans are a rare snack high in both fiber and complete plant protein, with no saturated fat.",
    tags: ["low-cal", "high-protein", "quick", "soy-protein"],
    ingredients: ["2 cups frozen edamame in pods", "Flaky sea salt", "Squeeze of lime (optional)", "Pinch chili flakes (optional)"],
    steps: ["Steam or boil the edamame 5 min.", "Drain and toss with sea salt.", "Add lime and chili if you like; eat warm."],
  },
  {
    id: "lentil-mushroom-bolognese",
    name: "Lentil & Mushroom Bolognese",
    type: "Dinner", time: 40, fiber: 14, protein: 18, sat: "low", cal: 420,
    why: "Lentils and mushrooms replace ground meat for a rich sauce with soluble fiber and none of the saturated fat.",
    tags: ["high-fiber", "high-protein", "freezer-friendly", "batch"],
    ingredients: ["1 cup brown lentils", "8 oz mushrooms, finely chopped", "1 onion, diced", "2 carrots, diced", "3 cloves garlic, minced", "1 can crushed tomatoes", "2 tbsp tomato paste", "1 tsp oregano", "1 tbsp olive oil", "3 cups whole wheat spaghetti"],
    steps: ["Sauté onion, carrot and mushroom in olive oil until softened.", "Add garlic, oregano and tomato paste; stir 1 min.", "Add lentils, tomatoes and 2 cups water; simmer 25–30 min.", "Serve over cooked whole wheat spaghetti."],
  },
  {
    id: "quinoa-stuffed-peppers",
    name: "Quinoa & Black Bean Stuffed Peppers",
    type: "Dinner", time: 45, fiber: 12, protein: 15, sat: "low", cal: 360,
    why: "Quinoa and black beans fill peppers with fiber and complete protein — satisfying without cheese or meat.",
    tags: ["high-fiber", "high-protein", "gluten-free", "batch"],
    ingredients: ["4 bell peppers, halved", "1 cup cooked quinoa", "1 can black beans, drained", "½ cup corn", "1 cup salsa", "1 tsp cumin", "1 tsp chili powder", "2 scallions, sliced", "Lime"],
    steps: ["Mix quinoa, beans, corn, salsa and spices.", "Spoon into the pepper halves; cover with foil.", "Bake at 375°F / 190°C for 30 min.", "Top with scallions and a squeeze of lime."],
  },
  {
    id: "cuban-black-bean-soup",
    name: "Cuban-Style Black Bean Soup",
    type: "Dinner", time: 35, fiber: 15, protein: 16, sat: "very low", cal: 300,
    why: "A big-batch black bean soup that's almost pure soluble fiber and plant protein, with essentially no saturated fat.",
    tags: ["low-cal", "high-fiber", "freezer-friendly", "one-pot", "batch"],
    ingredients: ["2 cans black beans", "1 onion, diced", "1 bell pepper, diced", "4 cloves garlic, minced", "1 tbsp olive oil", "1 tsp cumin", "1 tsp oregano", "3 cups veg broth", "1 tbsp lime juice", "Cooked brown rice to serve"],
    steps: ["Sauté onion and pepper in olive oil; add garlic and spices.", "Add beans and broth; simmer 20 min.", "Blend half the soup for body, then stir it back in with the lime.", "Serve over brown rice."],
  },
];

// Servings one batch of each recipe (as written) yields — used by the weekly
// planner to spread batch-cooked dishes across days as leftovers, and to scale
// the shopping list. Rough estimates from ingredient amounts.
export const SERVINGS = {
  // Breakfast
  "pb-banana-oats": 1,
  "berry-walnut-oatmeal": 1,
  "tofu-scramble": 2,
  "apple-cinnamon-oats": 2,
  "vanilla-chia-pudding": 2,
  "pb-green-smoothie": 1,
  "bircher-muesli": 1,
  "bean-breakfast-burrito": 1,
  // Lunch
  "tahini-chickpea-bowl": 2,
  "med-chickpea-salad": 2,
  "light-lemon-chickpea-salad": 2,
  "lentil-tabbouleh": 3,
  "edamame-soba-salad": 2,
  "barley-tahini-bowl": 3,
  "smashed-chickpea-sandwich": 2,
  // Snack
  "hummus-veg-plate": 3,
  "spiced-roasted-chickpeas": 4,
  "walnut-date-bites": 6,
  "edamame-sea-salt": 3,
  // Dinner
  "red-lentil-dal": 4,
  "black-bean-tacos": 3,
  "chickpea-spinach-curry": 4,
  "lentil-veg-soup": 6,
  "minestrone": 5,
  "three-bean-chili": 6,
  "tofu-broccoli-stirfry": 4,
  "white-beans-greens-pasta": 4,
  "stuffed-sweet-potato": 2,
  "veg-fried-rice": 4,
  "lentil-mushroom-bolognese": 5,
